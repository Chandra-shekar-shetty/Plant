...
public class IntroductionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mlist.add(new ScreenItem("Weather forecasting","Crop growth requires appropriate amount of tempreture.Detailed & accurate historical,real-time & forecast weather information can help the farmers better understand.",R.drawable.weather));
